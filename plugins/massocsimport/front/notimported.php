<?php
/*
 * @version $Id: notimported.php 135 2011-11-08 11:34:36Z remi $
 -------------------------------------------------------------------------
...
Html::header($LANG["massocsimport"]["common"][1], $_SERVER["PHP_SELF"], "plugins", "massocsimport");
Search::show('PluginMassocsimportNotimported');
